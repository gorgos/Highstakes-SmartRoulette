...
const CONTRACT_ADDRESS = '0xe3e046a161489c321c0bab2cecb83baa8101793c';
const NETWORK_NAME = 'rinkeby';

const abi = [{"constant":false,"inputs":[{"name":"_value","type":"uint8"}],"name":"sendUserValue","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"_hash","type":"bytes32"},{"name":"_address","type":"address"}],"name":"setBankHash","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"name":"_value","type":"uint8"}],"name":"debugShowHashForValue","outputs":[{"name":"","type":"bytes32"}],"payable":false,"stateMutability":"pure","type":"function"},{"constant":true,"inputs":[{"name":"","type":"address"}],"name":"gameRounds","outputs":[{"name":"storedBankHash","type":"bytes32"},{"name":"storedBankValue","type":"uint8"},{"name":"storedUserValue","type":"uint8"},{"name":"storedUserBet","type":"bool"},{"name":"blockWhenValueSubmitted","type":"uint256"},{"name":"lockedFunds","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"bankAddress","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"","type":"address"}],"name":"lastRouletteNumbers","outputs":[{"name":"","type":"uint8"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"_bet","type":"bool"},{"name":"_value","type":"uint8"},{"name":"_betAmount","type":"uint256"}],"name":"placeBet","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"_value","type":"uint8"},{"name":"_address","type":"address"}],"name":"sendBankValue","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"name":"","type":"address"}],"name":"registeredFunds","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"_random","type":"uint8"}],"name":"getRouletteNumber","outputs":[{"name":"","type":"uint8"}],"payable":false,"stateMutability":"pure","type":"function"},{"constant":false,"inputs":[],"name":"increaseFunds","outputs":[],"payable":true,"stateMutability":"payable","type":"function"},{"constant":false,"inputs":[],"name":"retrieveMoney","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"_address","type":"address"}],"name":"checkUserValueTimeout","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"anonymous":false,"inputs":[{"indexed":false,"name":"userAddress","type":"address"}],"name":"BankHashSet","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"_address","type":"address"}],"name":"FundsChanged","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"userAddress","type":"address"}],"name":"EvaluationFinished","type":"event"}];
  ...
  captcha.verify({ response: captchaResponse }, error => {
    ...
    s3.getObject({ Bucket: BUCKET, Key: itemKey }, (error, result) => {
      if (error) {
        ...
        process.chdir('/tmp');
        const data = rouletteInstance.sendBankValue.getData(
          value,
          userAddress,
          { from: BANK_ADDRESS },
        );
